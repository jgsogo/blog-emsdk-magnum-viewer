...
namespace Magnum { namespace Examples {
                        ...
                        .setWindowFlags(Configuration::WindowFlag::Resizable)}
        {
            ...
            args.addOption("file", CONAN_STL).setHelp("file", "file to load")
                    .addOption("importer", "StlImporter").setHelp("importer", "importer plugin to use")
            ...
            _cameraObject
                    .setParent(&_scene)
                    .translate(Vector3::zAxis(300.0f));
        ...
        void ColoredDrawable::draw(const Matrix4& transformationMatrix, SceneGraph::Camera3D& camera) {
            _shader
                    ...
                    .setLightPosition(camera.cameraMatrix().transformPoint({-300.0f, -300.0f, 500.0f}))
        ...
        void TexturedDrawable::draw(const Matrix4& transformationMatrix, SceneGraph::Camera3D& camera) {
            _shader
                    .setLightPosition(camera.cameraMatrix().transformPoint({-30.0f, 100.0f, 100.0f}))
                    .setTransformationMatrix(transformationMatrix)
                    .setNormalMatrix(transformationMatrix.normalMatrix())
                    .setProjectionMatrix(camera.projectionMatrix())
